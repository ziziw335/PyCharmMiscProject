...
echo ""
echo "下一步（推送到 GitHub）："
echo "  bash scripts/first-push.sh git@github.com:你的用户名/仓库名.git"
echo ""
echo "  说明: 必须先 commit 再 push；不要单独执行以 # 开头的注释行。"
echo "  Secrets 清单: scripts/github-secrets-checklist.md"
echo ""
echo "手动部署 VPS:  bash deploy_to_vps.sh"
